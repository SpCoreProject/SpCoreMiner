...
import spidev  # تغییر از spi به spidev
import signal
import time
import logging
...
class MFRC522:
    ...
    def MFRC522_Request(self, reqMode):
        ...
        (status, backBits, _) = self.MFRC522_ToCard(self.PCD_TRANSCEIVE, TagType)
    ...
    def MFRC522_Anticoll(self):
        ...
        (status, backData, _) = self.MFRC522_ToCard(self.PCD_TRANSCEIVE, serNum)
