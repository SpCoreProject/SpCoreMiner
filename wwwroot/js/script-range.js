...
var nest2 = new thermostatDial(document.getElementById('thermostat2'), {
    onSetTargetTemperature: function (v) {
        document.getElementById('input_target_temperature2').value = +v;
    }
});

//var nest3 = new thermostatDial(document.getElementById('thermostat3'), {
//    onSetTargetTemperature: function (v) {
//        document.getElementById('input_target_temperature3').value = +v;
//    }
//});
...
document.getElementById('input_target_temperature2').addEventListener('input', function () {
    nest2.target_temperature = this.value;
});
//document.getElementById('input_target_temperature3').addEventListener('input', function () {
//    nest3.target_temperature = this.value;
//});
document.getElementById('input_ambient_temperature').addEventListener('input', function () {
    nest.ambient_temperature = this.value;
});
document.getElementById('input_ambient_temperature2').addEventListener('input', function () {
    nest2.ambient_temperature = this.value;
});
//document.getElementById('input_ambient_temperature3').addEventListener('input', function () {
//    nes3t.ambient_temperature = this.value;
//});
